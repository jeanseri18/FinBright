...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/moussafofana/Documents/PROJETS/LARAVEL/FinBright/finbright-website/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/moussafofana/Documents/PROJETS/LARAVEL/FinBright/finbright-website/public/storage','fortify.guard','fortify.middleware',
...
'fortify.redirects.register','fortify.redirects.email-verification','fortify.redirects.password-reset','fortify.features','logging.default',
...
'password.email','password.store','register','user-profile-information.update',
...
'how-it-works','how-to-invest','about','faq','contact',
'contact.submit','legal-mentions','privacy-policy','terms-of-use','risk-management',
'investment-risks','emprunteur.dashboard','emprunteur.simuler','emprunteur.demande','emprunteur.mes-demandes',
'emprunteur.mon-profil','emprunteur.loan-requests.annuler','emprunteur.loan-requests.edit','emprunteur.loan-requests.update','investisseur.dashboard',
'investisseur.decouvrir','investisseur.investir','admin.dashboard','dashboard','profile.edit',
'profile.update','profile.destroy','verification.notice','verification.verify','verification.send',
'password.confirm','password.update','storage.local',);
        registerArgumentsSet('views', 
'about','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','back.admin.dashboard','back.emprunteur._footer','back.emprunteur._navigation',
'back.emprunteur._profile_container','back.emprunteur.dashboard','back.emprunteur.demandes.edit','back.emprunteur.demandes.liste','back.emprunteur.layouts',
'back.emprunteur.loan_requests.create','back.emprunteur.loan_requests.simulation_result','back.emprunteur.mon-profil','back.investisseur._footer','back.investisseur._navigation',
'back.investisseur.dashboard','back.investisseur.layouts','back.investisseur.projets.discover','back.layouts.admin','back.layouts.guest',
'back.layouts.investor','back.layouts.navigation','components.application-logo','components.auth-session-status','components.danger-button',
...
'contact','dashboard','faq','home','how-it-works',
'how-to-invest','investment-risks','layouts.app','legal-mentions','privacy-policy',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','risk-management',
'terms-of-use','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
