...
class UsersController extends Controller
{
    ...
    public function listeUtilisateurs(Request $request)
    {
        ...
        return view('back.admin.securite.utilisateurs', compact('utilisateurs', 'months'));
    }
    ...
    public function saveUtilisateurs(Request $request)
    {
        ...
        $utilisateur = Admin::updateOrCreate(
    ...
    public function jsonUtilisateur(Admin $utilisateur)
    {
    ...
    public function deleteUtilisateur($id)
    {
        ...
        return redirect()->route('admin.securite.utilisat$utilisateurs')
            ->with('success', "L'établissement « {$utilisateur->nom} » a été supprimé avec succès.");
    }
    ...
    public function listeTaux(Request $request)
    {
        ...
        return view('back.admin.securite.taux_interet', compact('taux', 'months'));
    }
    ...
    public function saveTaux(Request $request)
    {
        ...
        return redirect()->route('admin.securite.taux')
            ->with('success', $message);
    }
