                ...
                (r = [
                    {
                        ...
                        value: function () {
                            ...
                            if (KTDom.getElement("#".concat(t)) && L) {
                                ...
                                L.marker([40.724716, -73.984789], { icon: a })
                                    .addTo(r)
                                    .bindPopup(
                                        "430 E 6th St, New York, 10009.",
                                        { closeButton: !1 }
                                    )
                                    .openPopup(),
                                    ...
                                    tooltip: {
                                        ...
                                        custom: function (e) {
                                            var o = e.series,
                                                ...
                                                a = e.dataPointIndex,
                                                s = e.w,
                                                i = 1e3 * parseInt(o[r][a]),
                                                n = s.globals.seriesX[r][a],
                                                c = t[n],
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var t = [
                                ...
                                o = document.querySelector("#earnings_chart");
                            o && new ApexCharts(o, e).render();
                        },
                    },
                    {
                        ...
                        value: function () {
                            var t = [
                                    ...
                                    series: [
                                        {
                                            name: "series1",
                                            data: [
                                                70, 60, 75, 55, 35, 80, 100, 70,
                                                90, 65, 50, 85, 60, 75, 65, 80,
                                            ],
                                        },
                                    ],
                                    chart: {
                                ...
                                o = document.querySelector("#orders_chart");
                            o && new ApexCharts(o, e).render();
                        },
                    },
                    {
                        ...
                        value: function (t, e, o) {
                            var r = {
                                ...
                                a = document.querySelector("#".concat(t));
                            if (a) {
                                a.chart && a.chart.destroy();
                                var s = new ApexCharts(a, r);
                                (a.chart = s), s.render();
                            }
                        },
                    },
                    {
                        key: "initTeamsDatatable",
                        value: function () {
                            var t = document.querySelector("#teams_datatable");
                            if (t) {
                                var e = KTDataTable.getInstance(t);
                                e.on("checked", function () {
                                    KTToast.show({
                ...
                document
                    ...
                    .forEach(function (t) {
                        t.addEventListener("click", function (t) {
                            ...
                            r.initMyBalanceChart("my_balance_chart", e, o);
                        });
                    });
            }),
            KTDom.ready(function () {
                r.initCompanyProfileMap(),
                r.initContributionChart(),
                r.initMediaUploadsChart(),
                r.initEarningsChart(),
                r.initOrdersChart(),
                r.initTeamsDatatable();
            }),
            {}
        );
    })();
