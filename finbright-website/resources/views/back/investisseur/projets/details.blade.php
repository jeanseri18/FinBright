            ...
            <div class="col-span-2">
                <div class="kt-card kt-card-grid min-w-full">
                    <div class="kt-card-header">
                        ...
                        <button id="download_pdf" class="kt-btn kt-btn-outline">
                            <i class="ki-filled ki-exit-down">
                            </i>
                            Télécharger en PDF
                        </button>
                    </div>
                    <div id="amortissement_table" class="kt-card-table">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.10.1/html2pdf.bundle.min.js"
    integrity="sha512-GsLlZN/3F2ErC5ifS8sRVZF8XCo5P9Z/niHLTq3wFTRpBsK7uCEZlC6t4f2J8p6z3cF8Z6FKF0FzYx4fjOnG2g=="
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    downloadBtn.addEventListener("click", () => {
        const element = document.getElementById("amortissement_table");

        const opt = {
            margin:       0.5,
            filename:     'tableau_amortissement.pdf',
            image:        { type: 'jpeg', quality: 0.98 },
            html2canvas:  { scale: 2, useCORS: true }, // meilleure résolution + images externes
