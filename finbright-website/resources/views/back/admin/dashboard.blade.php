                            ...
                            <div class="flex flex-col gap-4">
                                <div class="flex flex-col gap-3 text-center">
                                    <h2 class="text-xl font-semibold text-mono">
                                        Mise en place rapide de nouvelles équipes
                                    </h2>
                                    <p class="text-sm font-medium text-secondary-foreground">
                                        Améliorez la formation et la gestion des équipes grâce à des outils faciles à utiliser pour la communication, 
                                        l'organisation des tâches et le suivi des progrès, le tout en un seul endroit.
                                    </p>
                                </div>
                                <div class="flex justify-center">
                                    <a class="kt-btn kt-btn-primary" href="/metronic/tailwind/demo10/public-profile/teams">
                                        Create Team
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="kt-menu" data-kt-menu="true">
                                <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px"
                                    ...
                                    <div class="kt-menu-dropdown kt-menu-default w-full max-w-[200px]"
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/metronic/tailwind/demo10/account/activity">
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/metronic/tailwind/demo10/account/home/settings-enterprise">
                                                <span class="kt-menu-icon">
                        ...
                        <div class="kt-card kt-card-grid h-full min-w-full">
                            <div class="kt-card-header">
                                ...
                                <div class="kt-input max-w-48">
                                    ...
                                    <input data-kt-datatable-search="#kt_datatable_1" placeholder="Rechercher une demande"
                                        type="text" />
                                </div>
                            </div>
                    ...
                    <div class="kt-card h-full">
                        ...
                        <div class="kt-card-content flex flex-col gap-5">
                            <div class="text-sm text-foreground">
                                Users on the block list are unable to send chat requests or messages to you anymore, ever,
                                or again
                            </div>
                                    ...
                                    <div class="flex items-center gap-2.5">
                                        ...
                                        <div class="flex flex-col gap-0.5">
                                            <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary"
                                                href="/metronic/tailwind/demo10/public-profile/teams">
                                                Esther Howard
                                            </a>
