<x-guest-layout>
    <div class="kt-card max-w-[370px] w-full">
        <form method="POST" action="{{ route('admin.password.update') }}" class="kt-card-content flex flex-col gap-5 p-10" id="reset_password_change_password_form">
            @csrf

            <div class="text-center">
                <h3 class="text-lg font-medium text-mono">Définir un nouveau mot de passe</h3>
