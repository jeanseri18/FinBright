                ...
                <div class="kt-scrollable-x-auto">
                    <div class="kt-menu gap-3" data-kt-menu="true">
                        <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary here"
                            data-kt-menu-item-overflow="true" data-kt-menu-item-placement="bottom-start"
                            ...
                            <div class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2">
                                <span
                                    class="kt-menu-title text-nowrap text-sm text-secondary-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-medium kt-menu-item-here:text-primary kt-menu-item-here:font-medium kt-menu-item-show:text-primary kt-menu-link-hover:text-primary">
                                    Profiles
                                </span>
                                <span class="kt-menu-arrow">
                                    <i
                                        class="ki-filled ki-down text-xs text-muted-foreground menu-item-active:text-primary kt-menu-item-here:text-primary menu-item-show:text-primary kt-menu-link-hover:text-primary">
                                    </i>
                                </span>
                            </div>
                            <div class="kt-menu-dropdown kt-menu-default py-2 min-w-[200px]">
                                <div class="kt-menu-item active">
                                    <a class="kt-menu-link" href="/metronic/tailwind/demo2/public-profile/profiles/default"
                                        tabindex="0">
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" href="/metronic/tailwind/demo2/public-profile/profiles/creator"
                                        tabindex="0">
                                        <span class="kt-menu-title">
                                            Creator
                                        </span>
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" href="/metronic/tailwind/demo2/public-profile/profiles/company"
                                        tabindex="0">
                                        <span class="kt-menu-title">
                                            Company
                                        </span>
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" href="/metronic/tailwind/demo2/public-profile/profiles/blogger"
                                        tabindex="0">
                                        <span class="kt-menu-title">
                                            Blogger
                                        </span>
                                ...
                                <div class="kt-menu-item" data-kt-menu-item-offset="-10px, 0"
                                    ...
                                    <div class="kt-menu-link" tabindex="0">
                                        ...
                                        <span class="kt-menu-arrow">
                                            <i class="ki-filled ki-down text-xs in-[.kt-menu-dropdown]:-rotate-90">
                                            </i>
                                        </span>
                                    </div>
                        ...
                        <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary"
                            ...
                            <div class="kt-menu-dropdown kt-menu-default py-2 min-w-[200px]">
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link"
                                        href="/metronic/tailwind/demo2/public-profile/projects/3-columns" tabindex="0">
                                        <span class="kt-menu-title">
                                            3 Columns
                                        </span>
                                    </a>
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link"
                                        href="/metronic/tailwind/demo2/public-profile/projects/2-columns" tabindex="0">
                                        <span class="kt-menu-title">
                                            2 Columns
                                        </span>
                                    </a>
                        ...
                        <div
                            ...
                            <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2"
                        ...
                        <div
                            class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary">
                            <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2"
                                href="/metronic/tailwind/demo2/public-profile/teams">
                                <span
                                    class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-item-here:text-primary kt-menu-item-here:font-semibold kt-menu-item-show:text-primary kt-menu-link-hover:text-primary">
                                    Teams
                                </span>
                        ...
                        <div
                            class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary">
                            <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2"
                                href="/metronic/tailwind/demo2/public-profile/activity">
                                <span
                                    class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-item-here:text-primary kt-menu-item-here:font-semibold kt-menu-item-show:text-primary kt-menu-link-hover:text-primary">
                                    Activity
                                </span>
                        ...
                        <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary"
                            ...
                            <div class="kt-menu-dropdown kt-menu-default py-2 min-w-[200px]">
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" href="/metronic/tailwind/demo2/public-profile/campaigns/card"
                                        tabindex="0">
                                        <span class="kt-menu-title">
                                            Campaigns - Card
                                        </span>
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" href="/metronic/tailwind/demo2/public-profile/campaigns/list"
                                        tabindex="0">
                                        <span class="kt-menu-title">
                                            Campaigns - List
                                        </span>
                ...
                <div data-kt-dropdown="true" data-kt-dropdown-placement="bottom-end"
                    ...
                    <div class="kt-dropdown-menu w-full max-w-[220px]" data-kt-dropdown-menu="true">
                        <ul class="kt-dropdown-menu-sub">
                            ...
                            <li>
                                <button class="kt-dropdown-menu-link" data-kt-dropdown-dismiss="true"
                                    data-kt-modal-toggle="#give_award_modal">
                            ...
                            <li>
                                <div class="kt-dropdown-menu-link">
                                    ...
                                    Stay Updated
                                    <input class="ms-auto kt-switch kt-switch-sm" name="check" type="checkbox"
                                        value="1" />
                                </div>
                            </li>
                            <li>
